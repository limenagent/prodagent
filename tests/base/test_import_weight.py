...
KERNEL_EXPECTED = frozenset(
    {
        ...
        "prodagent.kernel.turn",
        "prodagent.kernel.node_state",
        "prodagent.kernel.react",
        "prodagent.kernel.bodies",
        "prodagent.kernel.bodies.base",
        "prodagent.kernel.bodies.runner",
        "prodagent.kernel.types",
        "prodagent.ports",
        "prodagent.ports.execution",
        "prodagent.ports.agent_events",
        "prodagent.ports.observability",
        "prodagent.ports.budget_ledger",
        "prodagent.ports.persistence",
        "prodagent.ports.messaging",
        "prodagent.ports.llm",
