"""kernel.unit — the composable-interface vocabulary, on its own terms.
...
satisfies ``Unit`` structurally — the interface must not require inheritance.
"""
...
class _Echo:
    """The smallest structural Unit: no inheritance, just the method."""
