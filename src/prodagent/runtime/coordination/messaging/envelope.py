...
audit) via :mod:`prodagent.runtime.coordination.messaging.pipeline`.
...
class CrossingStopped(Exception):
    ...
    :meth:`Pipeline.process <prodagent.runtime.coordination.messaging.pipeline.Pipeline.process>`
