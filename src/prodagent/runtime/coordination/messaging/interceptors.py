...
if TYPE_CHECKING:
    ...
    from prodagent.runtime.coordination.floor_projection import FloorProjection
...
class ProjectionInterceptor:
    ...
    Wraps a :class:`~prodagent.runtime.coordination.floor_projection.FloorProjection`
