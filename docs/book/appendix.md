...
| 知识点 | 一句话 | 章节 |
|---|---|---|
| 类型注解 | 冒号后的类型是标签不是笼子；mypy 把它变成安检门 | [1.4](ch01.md) |
| `str \| None` | "或"关系；出现在返回值上意味着要处理"没有结果" | [1.4](ch01.md) |
...
| 核心只 4 个依赖 | 每个厂商 SDK、每个数据库驱动都是安装冲突与漏洞面 | [2.9](ch02.md) |
